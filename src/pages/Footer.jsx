...
const SocialIcon = ({ children, label, href, activeColor }) => (
  <a
    ...
    className="group relative flex h-9 w-9 items-center justify-center rounded-full text-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:brightness-110"
...
export default function Footer() {
  ...
  // Some pages (e.g. ProjectDetails) render inside a custom
  // overflow-y-auto container instead of the window.
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full px-4 pt-10 pb-8 sm:px-8 lg:px-12 lg:pt-16">
        {/* ---------- Brand Row ---------- */}
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-wrap items-center  gap-2 sm:gap-4">
              <img
                src={logo}
                alt="STUDIO DNA Logo"
                className="h-18 w-auto sm:-ml-8 -ml-8 shrink-0 object-contain sm:h-16 md:h-26 grayscale opacity-80"
              />
              <p className="text-gray-500 text-lg sm:text-xl">+</p>
              <img
                src={logo2}
                alt="Outline Architects Logo"
                className="h-18 w-auto shrink-0 object-contain sm:h-116 md:h-26 grayscale opacity-80"
              />

              <div className="w-full mt-2 sm:w-auto sm:mt-0 sm:ml-2">
                <div className="text-lg tracking-tight text-gray-700 sm:text-2xl lg:text-3xl font-serif">
                  STUDIO DNA
                </div>
                <div
                  className="text-[10px] tracking-[0.2em] text-[#8A8A8A] uppercase sm:text-xs my-0.5"
            ...
            <p
              className="mt-6 text-sm leading-relaxed text-gray-600 sm:text-base lg:text-lg max-w-3xl"
              style={{ fontFamily: "'JetBrains Mono', monospace" }}
            >
          ...
          {/* Social + newsletter */}
          <div className="lg:col-span-5 lg:pl-6 lg:pt-4">
            <p
              className="text-xs sm:text-sm tracking-[0.2em] text-gray-600 font-medium"
              style={{ fontFamily: "'JetBrains Mono', monospace" }}
            >
              — FOLLOW THE STUDIO
            </p>
            ...
            <form
              ...
              className="mt-8 flex items-center border-b border-gray-400/50 pb-2 focus-within:border-[#5b7fc7]"
            >
              <input
                type="email"
                required
                placeholder="your@email.com"
                className="w-full bg-transparent text-sm sm:text-base font-mono text-gray-800 placeholder:text-gray-500 focus:outline-none"
              />
              <button
                type="submit"
                className="ml-2 inline-flex items-center gap-1.5 text-xs sm:text-sm tracking-[0.2em] font-semibold text-gray-600 transition-colors duration-300 hover:text-[#5b7fc7]"
                style={{ fontFamily: "'JetBrains Mono', monospace" }}
              >
                <span>SUBSCRIBE</span>
        ...
        {/* ---------- Locations Section ---------- */}
        <div className="pt-10 mt-30  mb-30 border-t border-gray-300/30 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-12">
          {/* ================= 01 STUDIO DNA ================= */}
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-12 items-center">
            ...
            <div className="sm:col-span-6  sm:pl-16 sm:pt-8 order-2 sm:order-1 flex flex-col justify-end">
              ...
              <ul className="mt-5 space-y-4 font-mono text-base sm:text-lg text-gray-700">
                <li className="flex gap-3 items-start">
                  <MapPin size={20} className="mt-0.5 shrink-0 text-gray-500" />
            ...
            {/* Media Stack */}
            <div className="sm:col-span-6 flex flex-col gap-3 order-1 sm:order-2">
              <div className="group relative rounded-xl overflow-hidden shadow-sm">
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-3">
                  ...
                  <p
                    className="text-xs sm:text-sm tracking-[0.15em] font-medium text-white/70"
                    style={{ fontFamily: "'JetBrains Mono', monospace" }}
                  >
                    EST. 1994
                  </p>
        ...
        {/* ---------- Bottom Bar ---------- */}
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-gray-300/50 pt-6 sm:flex-row sm:items-center">
          <p
            className="max-w-2xl text-[11px] sm:text-xs leading-relaxed tracking-[0.1em] text-gray-600"
            style={{ fontFamily: "'JetBrains Mono', monospace" }}
          >
      ...
      {/* Floating Back to Top - small blue dot, arrow shows on hover (always visible on mobile) */}
      <button
        onClick={handleBackToTop}
        aria-label="Back to top"
        className="group fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-50 flex h-9 w-9 items-center justify-center rounded-full bg-[#5b7fc7] text-white shadow-md transition-all duration-300 hover:h-10 hover:w-10 hover:shadow-lg cursor-pointer"
      >
        <ArrowUp
          size={18}
