    ...
    <>
      <main className="relative z-10 w-full min-h-screen bg-white text-gray-900 font-mono overflow-hidden">
        ...
        <section className="relative w-full min-h-[50vh] sm:min-h-[45vh] flex items-end overflow-hidden">
          ...
          <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 lg:px-24 mt-16 py-12 md:py-16">
            <Reveal>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-mono font-bold text-gray-900 tracking-tight uppercase">
                Let's Build
                <br />
                Together.
              </h1>
        ...
        {/* ================= 2. OFFICES ================= */}
        <section className="relative w-full bg-white px-4 sm:px-8 md:px-12 lg:px-64 py-8 sm:py-12">
