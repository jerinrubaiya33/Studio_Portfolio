...
//   // Tracks the active card in the "How We Build" tabbed panel
...
//   const activeStep =
//     displayedProcess[activeStepIndex] || displayedProcess[0];
...
//   // Close the expanded service panel when clicking anywhere outside its row
//   useEffect(() => {
//     const closeOnOutsideClick = (e) => {
//       if (!e.target.closest("[data-service-row]")) {
//         setExpandedService(null);
...
//         <div
//           ref={servicesRef}
//           className="mt-14 md:mt-24 w-full px-50 py-20"
//         >
//           <div className="mb-6 md:mb-10">
//             <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl uppercase tracking-[0.1em] text-white font-bold font-mono">
//               — PRE-CONSTRUCTION & PLANNING
...
//                   onClick={() => handleServiceClick(index)}
//                   data-service-row={index}
//                   className={`group relative flex flex-col border-b-2 border-white cursor-pointer transition-all duration-300 w-full ${isHovered || isExpanded
//                       ? "bg-[#5b7fc7] text-white"
//                       : "hover:bg-gray-200/40 text-gray-900"
//                     }`}
//                 >
...
//                     <div className="flex items-center gap-3 md:gap-6 z-10">
//                       <span
//                         className={`text-base md:text-xl font-extrabold font-mono tracking-wider transition-colors duration-300 ${isHovered || isExpanded ? "text-white" : "text-gray-900"
//                           }`}
//                       >
//                         {item.num}
//                       </span>
//                       <h3
//                         className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl font-mono font-medium transition-transform duration-500 ease-out ${isHovered || isExpanded
//                             ? "translate-x-6 text-white font-mono font-semibold"
//                             : "text-gray-900"
//                           }`}
//                       >
...
//                     </div>                    <ArrowUpRight
//                       size={16}
//                       className={`z-10 shrink-0 text-white transition-all duration-300 ${isHovered || isExpanded
...
//                   <div
//                     onClick={(e) => e.stopPropagation()}
//                     className={`lg:hidden grid transition-all duration-500 ease-in-out ${isExpanded
//                         ? "grid-rows-[1fr] opacity-100"
//                         : "grid-rows-[0fr] opacity-0"
//                       }`}
//                   >
...
//                         left: `${hoverPos.x}px`,
//                       }}
//                       className="hidden lg:flex -mt-40 absolute z-30 h-[400px] w-[640px] shadow-2xl rounded-2xl overflow-hidden border border-white/60 
//                       pointer-events-none transition-all duration-150 ease-out animate-in fade-in zoom-in-95 backdrop-blur-md bg-[#dcd8c2]"
//                     >
//                       <div className="w-1/2 h-full overflow-hidden">
//                         <img
//                           src={item.image}
...
//             <button
//               onClick={handleServicesToggle}
//               className="group relative overflow-hidden flex items-center gap-3 text-sm sm:text-base 
//               md:text-lg font-bold tracking-[0.2em] text-gray-900 uppercase font-mono bg-[#dcd8c2] border-2 border-white px-6 md:px-7 py-3 md:py-3.5 rounded-full shadow-md hover:shadow-xl transition-all duration-500 cursor-pointer"
//             >
//               <span className="absolute -bottom-10 left-1/2 -translate-x-1/2 w-16 h-16 bg-[#5b7fc7] rounded-full scale-0 group-hover:scale-[8] transition-transform duration-700 ease-out pointer-events-none" />
...
//         {/* ---------- HOW WE BUILD (TABBED CARD PANEL) ---------- */}
//         <div ref={processRef} className="mt-14 md:mt-24 w-full">
//           <div className="text-center mb-8 md:mb-12">
//             <h2 className="inline-block text-2xl sm:text-3xl md:text-4xl lg:text-5xl uppercase text-white font-bold font-mono
//              border-b-2 border-white pb-2 md:pb-4">
//               How We Build
//             </h2>
//           </div>

//           <div className="w-full max-w-7xl mx-auto bg-[#dcd8c2] rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-10 shadow-2xl">
//             {/* Step Cards Row */}
...
//                     className={`relative flex flex-col items-center justify-end gap-2 sm:gap-3 rounded-xl md:rounded-2xl border p-3
//                      sm:p-4 h-36 sm:h-48 md:h-56 overflow-hidden transition-all duration-300 cursor-pointer ${isActive
//                         ? "border-white bg-gray-50 shadow-md"
//                         : "border-gray-200 bg-gray-50/60 hover:border-gray-400"
//                       }`}
//                   >
//                     {isActive && (
//                       <span className="absolute inset-x-0 bottom-0 h-14 sm:h-16 bg-gradient-to-t to-transparent blur-xl
//                        pointer-events-none" />
//                     )}
//                     <img
//                       src={sketchImg}
...
//                       w-[700px] md:w-[1000px] lg:w-[400px]
//                       max-w-none h-auto object-contain transition-all duration-300 ${isActive
//                           ? "opacity-100"
//                           : "opacity-30 grayscale"
//                         }`}
//                     />
//                     <span
//                       className={`relative z-10 text-[10px] sm:text-xs md:text-sm font-sans font-extrabold uppercase 
//                         tracking-wide text-center leading-tight transition-colors duration-300 ${isActive ? "text-[#5b7fc7]" : "text-gray-400"
//                         }`}
//                     >
//                       {item.title}
//                     </span>
...
//             {/* Active Step Detail */}
//             <div className="mt-6 md:mt-10 pt-6 md:pt-8 border-t border-white grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14">
//               {/* Left — Title + CTA */}
//               <div className="flex flex-col justify-between">
//                 <div>
//                   <span className="text-xs sm:text-sm font-mono font-semibold text-[#ffffff] uppercase tracking-widest">
//                     Step {activeStep.num}
//                   </span>
//                   <h3 className="mt-3 text-2xl sm:text-3xl md:text-4xl font-bold text-white font-mono leading-[1.15]">
//                     {activeStep.title}
//                   </h3>
//                 </div>
...
//                 <button
//                   onClick={handleProcessToggle}
//                   className="mt-6 md:mt-0 self-start rounded-full border border-white px-5 sm:px-6 py-2.5 sm:py-3 text-xs sm:text-sm
//                   font-mono font-bold uppercase tracking-widest text-white hover:bg-white hover:text-white transition-colors duration-300 cursor-pointer"
//                 >
//                   {showMoreProcess ? "Show fewer steps" : "See all steps"}
//                 </button>
//               </div>

//               {/* Right — Overview + Deliverables */}
//               <div className="flex flex-col divide-y divide-gray-200">
//                 <div className="pb-4 md:pb-6">
//                   <h4 className="text-sm sm:text-base md:text-2xl font-bold text-white font-mono mb-2">
//                     Overview
//                   </h4>
//                   <p className="text-sm sm:text-xl font-serif leading-relaxed text-gray-800">
...
//                       <li
//                         key={pIdx}
//                         className="flex items-center gap-2 text-sm sm:text-lg font-serif text-gray-800"
//                       >
